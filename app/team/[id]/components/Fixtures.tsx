    ...
    return (
        <div className="flex flex-col w-full justify-center items-center text-neutral-100">
            <div className="flex flex-col w-full justify-center items-center">
                <div className="flex w-full justify-center items-center p-2 bg-gradient-to-b from-gray-400/100 to-gray-800/50">
                    Upcoming Matches
                </div>
                <div className="flex items-center justify-center relative overflow-hidden w-full">
                    ...
                    >
                        <ChevronDoubleLeftIcon 
                            className={`h-10 w-10 $(currentIndex === 0 ? "text-gray-500" : "text-neutral-100")`}
                        />
                    </button>
                    <div 
                    ...
                    >
                        {
                            firstItemsFixturesFuture.map((fixture, i) => (
                                <Link
                                    ...
                                    className="w-full flex-shrink-0 flex text-neutral-100 items-center h-36 bg-gradient-to-b from-gray-800/100 to-black/25 hover:bg-blue-800/50"
                                >
                    ...
                    >
                        <ChevronDoubleRightIcon 
                            className="{`h-10 w-10 $(currentIndex === firstItemsFixturesFuture.length ? 'text-gray-500' : 'text-neutral-100')`}"
                        />
                    </button>
                </div>
            </div>
            <div className="flex flex-col w-full justify-center items-center">
                ...
                </div>
                {
                    firstItemsFixturesDone.map((fixture, i) => (
                        <div 
                            key={i}
                            className="flex w-full text-neutral-100 items-center h-36 bg-gradient-to-b from-gray-800/100 to-black/25 hover:bg-blue-800/50">
                            <Link
                                href={`/match/${fixture.fixture.id}`}
                                key={fixture.fixture.id}
                                className="w-full flex text-neutral-100 items-center h-36 bg-gradient-to-b from-gray-800/100 to-black/25 hover:bg-blue-800/50"
                            >
                                <div className="flex flex-col justify-center items-center w-3/12 text-sm text-center">
                                    <Image
                                        src={fixture.teams.home.logo}
                            ...
                            <div className={`w-[2%] h-full ${!fixture.teams.home.winner && !fixture.teams.away.winner ? "bg-slate-600" : (fixture.teams.home.winner && fixture.teams.home.id === teamId) || (fixture.teams.away.winner && fixture.teams.away.id === teamId) ? "bg-green-500" : "bg-red-500"}`}>
                            </div>
                        </div>
                    ))
                }
                {
                    visibleItemsCount < fixturesByTeamId.length && (
                        <div className="p-2">
                            <button
                                className="bg-gradient-to-b from-gray-800/100 to-black/25 p-4"
