...
def build_training_comparison(
    ...
    for target in sorted(current_training_stats):
        current_metrics = current_training_stats[target].get("detailed_metrics", {})
        targets[target] = {
            "validation": current_training_stats[target].get("validation"),
            "date_ranges": current_training_stats[target].get("date_ranges"),
            "feature_set": current_training_stats[target].get("feature_set"),
            "feature_count": current_training_stats[target].get("features"),
